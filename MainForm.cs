...
private void InitializeBrowserTabControl()
{
    ...
    private void OpenImageViewer(string path)
    {
        ...
        if (existing != null)
        {
            ...
            if (!string.Equals(existing.CurrentPath, path, StringComparison.OrdinalIgnoreCase) || !existing.HasLoadedImage)
            {
                if (mediaKind == PreviewKind.Video)
                {
                    ...
                    existing.LoadVideoStill(path, _settings.Preview.VideoStillPreviewFfmpegPath, initialSeconds, _settings.Preview.VideoPlaybackVolumePercent);
                }
                else
                {
        ...
        {
            int initialSeconds = _settings.Preview.VideoSkipSeconds;
            viewer.LoadVideoStill(path, _settings.Preview.VideoStillPreviewFfmpegPath, initialSeconds, _settings.Preview.VideoPlaybackVolumePercent);
        }
        else
        {
            ...
            else if (kind == PreviewKind.Video)
            {
                ...
                if (openViewer != null)
                {
                    ...
                    openViewer.LoadVideoStill(
                        fullPath,
                        _settings.Preview.VideoStillPreviewFfmpegPath,
                        initialSeconds,
