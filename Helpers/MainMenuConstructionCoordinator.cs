...
internal sealed class MainMenuConstructionCoordinator
{
    ...
    internal sealed class BuildContext
    {
        ...
        public required Func<string, string> GetBrowserCommandShortcutHint { get; init; }
    ...
    public BuildResult Build(BuildContext context)
    {
        ...
        fileMenu.DropDownItems.Add(context.CreateMenuItem("名前変更(&R)", (s, e) => context.ExecuteRename(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.FileRename)));
        fileMenu.DropDownItems.Add(context.CreateMenuItem("削除(&D)", (s, e) => context.ExecuteDelete(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.FileDelete)));
        ...
        fileMenu.DropDownItems.Add(context.CreateMenuItem("新規フォルダ(&K)", (s, e) => context.ExecuteCreateDirectory(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserCreateDirectory)));
        fileMenu.DropDownItems.Add(context.CreateMenuItem("新規ファイル(&N)", (s, e) => context.ExecuteCreateFile(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserCreateFile)));
        fileMenu.DropDownItems.Add(new ToolStripSeparator());
        ...
        moveMenu.DropDownItems.Add(context.CreateMenuItem("親へ(&U)", (s, e) => context.NavigateParent(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserNavigateParent)));
        ...
        moveMenu.DropDownItems.Add(context.CreateMenuItem("エクスプローラーで開く(&X)", (s, e) => context.OpenExplorer(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserOpenExplorer)));
        moveMenu.DropDownItems.Add(context.CreateMenuItem("Top(&T)", (s, e) => context.ExecuteTop(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserCursorTop)));
        ...
        ToolStripMenuItem toggleBrowserTabReadOnlyMenuItem = context.CreateMenuItem("現在のタブを ReadOnly にする(&Y)", (s, e) => context.ToggleActiveBrowserTabReadOnly(), browserOnly: true, requiresIdle: false, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: null);
        moveMenu.DropDownItems.Add(toggleBrowserTabReadOnlyMenuItem);
        moveMenu.DropDownItems.Add(context.CreateMenuItem("次のタブへ(&X)", (s, e) => context.SelectNextBrowserTab(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserTabNext)));
        moveMenu.DropDownItems.Add(context.CreateMenuItem("前のタブへ(&P)", (s, e) => context.SelectPreviousBrowserTab(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserTabPrevious)));
        moveMenu.DropDownItems.Add(context.CreateMenuItem("現在のタブを閉じる(&W)", (s, e) => context.CloseCurrentBrowserTab(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserTabClose)));

        ToolStripMenuItem toolsMenu = new("ツール(&T)");
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("圧縮(&P)", (s, e) => context.ExecutePack(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.ArchivePack)));
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("解凍(&U)", (s, e) => context.ExecuteUnpack(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.ArchiveUnpack)));
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("外部エディタで開く(&E)", (s, e) => context.ExecuteOpenWithEditor(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: true, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserOpenExternalEditor)));
        ...
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("PowerShellをここで開く(&P)", (s, e) => context.OpenPowerShell(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserOpenShell)));
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("フルパスをコピー(&Y)", (s, e) => context.CopyFullPath(), browserOnly: true, requiresIdle: true, requiresSelection: true, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserCopyFullPath)));
        toolsMenu.DropDownItems.Add(new ToolStripSeparator());
        toolsMenu.DropDownItems.Add(context.CreateMenuItem("マーク一覧 / スロット(&M)", (s, e) => context.OpenMarkSlotDialog(), browserOnly: true, requiresIdle: true, requiresSelection: false, requiresFile: false, requiresEditorTarget: false, requiresExactlyTwoSelection: false, requiresTwoFiles: false, shortcutHint: context.GetBrowserCommandShortcutHint(CommandIds.BrowserOpenMarkSlot)));
